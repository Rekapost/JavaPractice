...
public class Employee {
		...
		public double monthlySalary(double basicPay,double basic_Allowance,double bonus) { 
		...
		*/
		...
		public static void main(String[] args) {
			...
			employee.monthlySalary(basicPay,basic_Allowance,bonus);
